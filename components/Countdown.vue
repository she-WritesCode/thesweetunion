...
<template>
  ...
  <div v-else class="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 max-w-2xl mx-auto py-8">
    <div
      v-for="block in [
    ...
    >
      ...
      <div class="absolute top-0 left-0 right-0 h-1 bg-amber-gold/50 group-hover:bg-deep-terracotta transition-colors duration-300" />
