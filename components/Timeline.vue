...
<template>
  <div class="relative border-l border-amber-gold/30 ml-4 md:ml-[50%] md:border-l-0 py-8 select-text">
    ...
    >
      ...
      >
        <div class="linen-card overflow-hidden rounded-2xl border border-amber-gold/20 transition-all duration-500 hover:shadow-xl hover:border-amber-gold/45 bg-linen-white">
          ...
          <div class="relative w-full aspect-[4/3] overflow-hidden bg-deep-espresso/5 border-b border-amber-gold/10">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-deep-espresso/30 to-transparent pointer-events-none mix-blend-multiply" />
          </div>

          <!-- Card Text Content -->
          <div class="p-6 sm:p-8">
            <span class="inline-block font-heading text-xs font-semibold text-amber-gold tracking-widest uppercase mb-2">
              {{ item.label }}
            </span>
