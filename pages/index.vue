  ...
  <div class="min-h-screen bg-warm-cream text-deep-espresso flex flex-col relative select-text">
    ...
    <section id="hero" class="min-h-screen w-full flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div class="relative z-10 text-center px-4 max-w-4xl mx-auto mt-auto mb-24 text-warm-cream">
        ...
        <h1 class="text-5xl sm:text-6xl md:text-8xl font-bold leading-none tracking-wide mb-5 drop-shadow-md font-display-cinzel">
    ...
    <section class="min-h-screen paper-texture w-full flex items-center justify-center p-6 border-b border-amber-gold/10">
      <FadeInSection>
        <div class="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-center lg:text-left space-y-6">
            ...
            <p class="text-deep-espresso/70 max-w-md mx-auto lg:mx-0 font-body text-lg">
              We've known each other for a long time. Now, we are counting down the hours until our traditional celebration.
            </p>
            <Countdown :target-date="siteConfig.weddingDate" />
          </div>
    ...
    <!-- Our Story Section -->
    <section id="story" class="min-h-screen paper-texture w-full flex items-center justify-center p-6 py-24 border-b border-amber-gold/10">
      <div class="w-full max-w-6xl mx-auto flex flex-col justify-center">
        <FadeInSection>
          ...
          <ScrapbookTimeline :items="siteConfig.story" @image-click="setLightboxImage" />
        </FadeInSection>
      </div>
    </section>
    ...
    <div id="events">
      <section
        v-for="(event, index) in siteConfig.events"
        :key="event.key"
        ...
        <FadeInSection>
          <div class="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="space-y-8" :class="index % 2 === 0 ? 'order-1' : 'order-1 lg:order-2'">
              ...
              <div>
                ...
                <div class="space-y-5 relative border-l border-amber-gold/20 pl-6 ml-2">
                  <div v-for="(item, scheduleIdx) in event.schedule" :key="scheduleIdx" class="relative group">
                    <div class="absolute left-[-31px] top-1.5 w-3.5 h-3.5 rounded-full border border-amber-gold bg-warm-cream flex items-center justify-center transition-all duration-300">
              ...
              <div v-if="event.rsvpTeaser && event.rsvpLink" class="linen-card p-6 rounded-2xl border border-amber-gold/15 bg-linen-white/40 space-y-3">
            ...
            >
              ...
              <div v-if="event.venue?.googleMapsEmbedUrl" class="w-full max-w-sm sm:max-w-md h-[180px] rounded-2xl overflow-hidden shadow-inner border border-amber-gold/15 mt-8 relative">
                <iframe
    ...
    <section id="wishlist" class="min-h-screen paper-texture w-full flex items-center justify-center p-6 border-b border-amber-gold/10">
      <FadeInSection>
        <div class="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="linen-card p-8 sm:p-10 rounded-2xl flex flex-col justify-between items-start border border-amber-gold/15 transition-all duration-300 hover:shadow-lg order-1 lg:order-2">
            <div class="mb-6">
    ...
    <section id="faqs" class="min-h-screen paper-texture w-full flex items-center justify-center p-6 border-b border-amber-gold/10">
      <FadeInSection>
        <div class="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="order-1 lg:order-2 space-y-4 max-h-[85vh] overflow-y-auto pr-2">
            <div class="mb-4">
              ...
              <h2 class="text-3xl sm:text-4xl font-bold text-deep-espresso font-display-cinzel">
                Frequently Asked
              </h2>
            </div>
